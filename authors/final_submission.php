<?php
 $title = "SIGCSE 2010 - Final Submission";
 $menu = "presenters";
 ...
 <tr>
  ...
  <td width="50%" align="center" valign="top">
    <div id="GoodMessage">
      ...
      <table>
       <tr>
        <td align="left" valign="top">Title/Author Modifications:</td><td align="left">November 9, 2009</td>
       </tr>
       <tr>
  	    <td align="left">Final Version to SIGCSE DB:</td><td align="left">December 7, 2009</td>
       </tr>
       <tr>
 	    <td align="left">Final Version to Publisher:</td><td align="left">December 7, 2009</td>
       </tr>
       <tr>
  	    <td align="left">Copyright/Permission Form Due:</td><td align="left">December 7, 2009</td>
       </tr>
      </table>
    </div>
...
<p><strong style="color: #FF0000;">Due by Monday, November 9, 2009</strong></p>
            ...
            <ul>
              <li> Double-check the information about your submission
                   ...
                   <strong>final</strong> title and author list
                   <strong>immediately</strong> in the online database.
                   <strong style="color: #FF0000;">THIS MODIFICATION IS URGENT</strong>
                   ...
                   <a href="http://db.grinnell.edu/sigcse/sigcse2010/Submissions/submissionRegular.asp">Form for Submitting Materials and Updating Proposer Information</a>
                   and proceed to the section entitled
                   <strong>Verify/Update Previously-Submitted Materials</strong>.
                   </p>
                   ...
                   <ul>
                     <li> Select among panel, paper, special session
                          or workshop
                          </li>
                     <li> Enter your submission ID and password
                          </li>
                     <li> Click on the button for Verify / Update
                          </li>
                   </ul>
...
<ol>
              <li> <strong>Verify Conformance to All Formatting Guidelines:</strong>
                   ...
                   <a href="/sigcse2010/presenters/format.php">SIGCSE 2009 Format Instructions</a>
...
<p>
            ...
            <ol>
              <li> <strong>Complete final editing and create a PDF file
                   ...
                   Refer to our
                   <a href="/sigcse2010/presenters/creating_pdf.php">hints on creating PDF documents</a>.
      ...
      <strong>After confirmation from the publisher, submit the signed ACM Copyright Form or Permission Form.</strong>
              ...
              <li> <strong>Send email to the publications chair to indicate
                   ...
                   <p style="font-size: 1.0em">
                   Send email to the Publications Chair, Dave Musicant <script language="javascript">write_email( "sigcse10-publications", "cs.xu.edu" );</script>, with the subject line
                   ...
                   <p style="font-size: 1.0em">
                   This email will inform the Publications Chair, Dave Musicant <script language="javascript">write_email( "sigcse10-publications", "cs.xu.edu" );</script>,
                   that:
                   </p>
