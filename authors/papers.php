...
<p>We invite papers falling into the following four broad classes.</p>
		...
		<ul>
			...
			<li>
				<strong>Tool</strong> papers present courseware or a concrete process that has been developed and is now ready for wider use.
			</li>
		</ul>
		<p>
...
<ol>
              <li> Write your paper using the format specified above.
	...
	<!-- a href="http://www.cs.grinnell.edu/~sigcse/sigcse2011/submission.shtml">online Paper Submission Form</a>. -->
              ...
              <li> Make note of the paper ID number and password assigned
...
<!--	               <a href="http://www.cs.grinnell.edu/~sigcse/sigcse2011/submission.shtml">Author Verification Form</a> -->
                   ...
                   <a href="http://www.adobe.com/products/reader/">Acrobat Reader</a> directly.
                   </li>
            </ol>
...
<h2><a name="presentation">Presentation Notes</a></h2>
            ...
            <ul>
              <li> <strong>All presenters must register for the conference</strong>.
                   </li>

              <li> Paper presentations are <strong>25 minutes</strong>
                   in length. Five minutes of that time should be reserved for
                   answering questions from the audience.
                   </li>

              <li> Plan to attend the <strong>speakers' breakfast</strong>
              ...
              <li> The conference supplies a projector but not a laptop.  You
                   will need to <strong>bring a laptop or arrange to use one
                   from another attendee</strong>. You may want to contact your
              ...
              <li> Wireless Internet access should be available during your
                   presentation, but you should, of course, be aware there
                   is always a potential for failure.
                   </li>

              <li> Arrive at your room 
                   <strong>at least 10 minutes before</strong> the session
