...
<div class="errorExplanation">Failure to follow these instructions may jeopardize the inclusion of your paper in the proceedings.</div>
...
<li><b>Categories and Subject Descriptors:</b> The ACM Computing Classification Scheme is available at http://www.acm.org/class/1998/ Most submissions are likely to use category K.3.2 Computer and Information Science Education. The title of this section ("Categories and Subject Descriptors") should be formatted as a subsection head (i.e., flush left, Times Roman, bold, 12 point, Initial Letters Capitalized).</li>
