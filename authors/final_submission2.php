...
<p><strong style="color: #FF0000;">Due by TBA</strong></p>

            <ul>
              <li> Double-check the information about your submission
                   that is recorded in the SIGCSE 2011 database.
...
<p>
            ...
            <ol>
              <li> <strong>Complete final editing and create a PDF file
                   ...
                   Refer to our
                   <a href="/sigcse2010/authors/creating_pdf.php">hints on creating PDF documents</a>.
              ...
              <li> <strong>Submit the
                   ...
                   by accessing the
                   <a href="http://db.grinnell.edu/sigcse/sigcse2011/Submissions/submissionRegular.asp">Form for Submitting Materials and Updating Proposer Information</a>.
                   </p>
      ...
      <strong>After confirmation from the publisher, submit the signed ACM Copyright Form or Permission Form.</strong>
              ...
              <li> <strong>Send email to the publications chair to indicate
                   ...
                   <p style="font-size: 1.0em">
                   Send email to the Publications Chair, Lester McCann <script language="javascript">write_email( "sigcse11-publications", "cs.cmu.edu" );</script>, with the subject line
                   ...
                   <p style="font-size: 1.0em">
                   This email will inform the Publications Chair, Lester McCann <script language="javascript">write_email( "sigcse11-publications", "cs.cmu.edu" );</script>,
                   that:
                   </p>
