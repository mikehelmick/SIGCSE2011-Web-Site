...
<h2><a name="panel">What Is A Panel?</a></h2>
            ...
            than four panelists <i>must convincingly show</i> that all
...
<h2><a name="format">How Should The Proposal Be Formatted?</a></h2>
            ...
            <ul>
              <li> When providing author information, indicate which
                   of the panelists is the moderator by placing the word
                   &quot;Moderator&quot; in parentheses after her/his name.
                   </li>

              <li> Do not include an abstract. Instead, the first section
                   should be titled <strong>Summary</strong> and should
                   provide a summary of the panel written by the moderator.
                   </li>

              <li> Subsequent sections should contain the position
                   statements of each panelist.  Title each section by
                   identifying the author.
                   </li>

              <li> References where appropriate are encouraged, but not
                   required.  If they are included, they should be placed
                   in a separate section titled <strong>References</strong>
...
<h2><a name="submit">How Do I Submit My Proposal?</a></h2>
 ...
 <p>
            ...
            <ol>
              ...
              <li> Please do not wait until the last minute to submit
                   your documents because that is when everyone else
                   will be connecting to our server!
                   </li>

              <li> Make note of the proposal ID number and password
                   assigned to your submission. <strong>You will need them later.</strong>
              ...
              <li> After receiving confirmation, go to the 
                   <a href="http://www.cs.grinnell.edu/~sigcse/sigcse2011/submission.shtml">Author Verification Form</a> to review your submission for accuracy.
                   Send e-mail to
    ...
    <script>write_email( "sigcse11-specials", "cs.cmu.edu" );</script> (Pam Cutter)
                   ...
                   <a href="http://www.adobe.com/products/reader/">Acrobat Reader</a>
                   directly.
                   </li>
            </ol>
...
<h2><a name="presentation">Presentation Notes</a></h2>
            ...
            <ul>
              ...
              <li> All presenters must register for the conference.
                   </li>

              <li> Panel sessions are 75 minutes in length.  The session
              ...
              <li> Wireless Internet access should be available during
                   your presentation, but you should, of course, be aware
                   that there is always potential for failure.
                   </li>

              <li> Arrive at your room at least 10 minutes before the
...
<b>Panels and Special Sessions</b><br/>
	...
	<script>write_email( "sigcse11-panels", "cs.cmu.edu" );</script></p>
