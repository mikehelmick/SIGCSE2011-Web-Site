<?php
 $title = "SIGCSE 2011 - Pre-Symposium Events";
 $menu = "attendees";
 include("../parts/top.php");
?>       
<h1>SIGCSE 2011 Pre-Symposium Events</h1>

<div class="SectionHeader"><div class="Full">
<h2><a name="csta">CSTA Source Web Repository Cataloging Workshop</a></h2>
</div></div>
<img src="/sigcse2011/images/clock.png" align="absmiddle" />Wednesday, March 9, 2011, 8:00am to 3:30pm.	
...
<ul>
 <li>Jeff Forbes, Duke University - <script>write_email("jforbes", "duke.edu");</script></li>
 <li>Owen Astrachan, Duke University - <script>write_email("ola", "cs.duke.edu");</script></li>	
</ul>
</p>
...
<img src="/sigcse2011/images/clock.png" align="absmiddle" />Wednesday, March 9, 2011, 1:00pm - 5:30pm
...
<p>Organizers and affiliations: SIGCAS, Florence Appel, Saint Xavier University</p>
...
previous years, the symposium will be highly interactive, taking place entirely in plenary sessions. In
...
<li>Trishan de Lanerolle, Trinity College</li>
<li>Danny Krizanc, Wesleyan University</li>
<li>Norman Danner, Wesleyan University</li>
<li>Gary Parker, Connecticut College</li>
<li>Ozgur Izmirli, Connecticut College</li>
<li>Carlos Espinosa, Trinity College</li>
<li>Allen Tucker, Bowdoin College </li>
</ul>
</p>
